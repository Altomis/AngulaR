...
angular.module("angular-cron-jobs").directive("cronSelection", ["cron", "baseFrequency", function(cron, baseFrequency) {
    return {
        restrict: "EA",
        replace: true,
        transclude: true,
        ...
        link: function($scope, $el, $attr, $ngModel) {
            ...
            $scope.$watch("ngModel", function (newValue) {
                if (angular.isDefined(newValue) && newValue) {
                    modelChanged = true;
                    $scope.myFrequency = cron.fromCron(newValue, $scope.allowMultiple, $scope.cronStyle);
                } else if (newValue === "") {
            ...
            $scope.$watch("myFrequency", function (n, o) {
                if (n !== undefined) {
                    ...
                    var newVal = cron.setCron(n, $scope.cronStyle);
